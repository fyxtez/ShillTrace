...
import { Eye, EyeOff, Pin, PinOff, Search, X } from 'lucide-react'
import { api } from '../api'
import type { Channel, Shill } from '../types'
import { ago, cap, fx, longAgo, ratio, shortAddress } from '../utils/format'
import { Avatar, ChainIcon, ChannelAvatar } from './TokenIdentity'
import './ChannelsPage.css'

export function ChannelsPage({ channels, shills, ignored, refresh, onOpenShill }: { channels: Channel[], shills: Shill[], ignored: boolean, refresh: () => void, onOpenShill: (shill: Shill) => void }) {
