...
export default function App() {
  const {page,setPage,changePage,shills,channels,selected,setSelected,history,search,setSearch,loading,pollSeconds,sidebarCollapsed,setSidebarCollapsed,filtered,unseen,refresh,act}=useShillTrace()
